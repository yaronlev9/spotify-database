    ...
    return (
            <div>
                <div className="page" style={{color:'white'}}>
                    <img style={{'borderRadius': '50%'}} src={ArtistImg} width="300px" height="300px" alt={ArtistName}></img>
                    <span className="info">
                        <div style ={{fontSize:"24px", position:"relative", left:"5%"}}>{ArtistName}</div>
                    </span>
                </div>
                <div className="songs">
                    <h2>Top songs:</h2>
                    ...
                    <div className="record" key={i}>
                        <Link style={{color:'white'}} to={`/song/${item.SongID}/?artist=${ArtistID}`}>
                ...
                <Carousel responsive={responsive}
                    ...
                    {allAlbums.map((item,i)=> <div key={i}>{item}</div>)}
                </Carousel>
                </div>
            </div>
    );

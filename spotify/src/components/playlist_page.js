    ...
    return (
            <div>
                <div className="page" style={{color:'white'}}>
                    <img src={playlistImg} width="256" height="256" alt={playlistName}></img>
                    <span className="info">
                        <div>{playlistName}</div>
                        <div>playlist</div>
                        <div>Created at: {playlistCreated}</div>
                        <div>{allSongs.length} songs in playlist</div>
                    </span>
                </div>
                <div className="songs">
                    {allSongs.map((item,i)=> 
                    <div className="record" key={i}>
                        <Link style={{color:'white'}} to={`/song/${item.SongID}/?playlist=${playlistID}`}>
